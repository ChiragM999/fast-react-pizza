...
## Installation
- Clone this repository:  `git clone https://github.com/ChiragM999/fast-react-pizza.git`
- Navigate to the project directory:  `cd fast-react-pizza`
- Install dependencies:  `npm install`
- Start the development server:  `npm run dev`

## Live Demo
Check out the live version of "Fast React Pizza" [here](https://fast-react-pizza-chiragm999.netlify.app/]).
